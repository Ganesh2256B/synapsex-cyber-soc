...
// Initialize global web polyfills
initPolyfills();
...
export const App: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Floating Capabilities Guide Launch Pill */}
      <button
      ...
      {/* Main SynapseX Landing Page 5 Sections */}
      <main>
      ...
      {/* Cyber Threat Operations Center (Mini SOC) Modal with Real 3D Earth */}
      <SocModal
        isOpen={isSocOpen}
